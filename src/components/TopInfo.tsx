...
export default function TopInfo() {
  return (
    <>
      <div className="flex items-center overflow-x-scroll whitespace-nowrap no-scrollbar gap-[20px] h-[80px] sreg bg-[#20252B] border border-[#262932] rounded-[8px] px-[20px]">
